		...
		<div class="panel-body">
			...
			<div role="tabpanel">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#attributes" aria-controls="attributes" role="tab" data-toggle="tab">{{{ trans('sanatorium/inputs::groups/common.tabs.attributes') }}}</a></li>
				</ul>
						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="form-group{{ Alert::onForm('name', ' has-error') }}">
									...
									<input type="text" class="form-control" name="name" id="name" placeholder="{{{ trans('sanatorium/inputs::groups/model.general.name') }}}" value="{{{ input()->old('name', $group->name) }}}">
								...
								<div class="form-group{{ Alert::onForm('slug', ' has-error') }}">
									...
									<input type="text" class="form-control" name="slug" id="slug" placeholder="{{{ trans('sanatorium/inputs::groups/model.general.slug') }}}" value="{{{ input()->old('slug', $group->slug) }}}">
