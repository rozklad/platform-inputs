...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'form');

		$('.daterangepicker_end_input').attr('data-grid', 'form');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('form', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
