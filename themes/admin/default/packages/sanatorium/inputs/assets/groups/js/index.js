...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'group');

		$('.daterangepicker_end_input').attr('data-grid', 'group');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('group', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
